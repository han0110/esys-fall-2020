...
inline void ns_log_errorln(nsapi_error_t error, const char* msg, ...) {
  ...
  log_errorln("code: %d, msg: %s", error, buffer);
  va_end(args);
  ...
  switch (error) {
    ...
    case NSAPI_ERROR_UNSUPPORTED:
      log_debugln("NSAPI_ERROR_UNSUPPORTED: unsupported functionality");
      break;
    case NSAPI_ERROR_PARAMETER:
      log_debugln("NSAPI_ERROR_PARAMETER: invalid configuration");
      break;
    case NSAPI_ERROR_NO_CONNECTION:
      log_debugln("NSAPI_ERROR_NO_CONNECTION: not connected to a network");
      break;
    case NSAPI_ERROR_NO_SOCKET:
      log_debugln("NSAPI_ERROR_NO_SOCKET: socket not available for use");
      break;
    case NSAPI_ERROR_NO_ADDRESS:
      log_debugln("NSAPI_ERROR_NO_ADDRESS: ip address is not known");
      break;
    case NSAPI_ERROR_NO_MEMORY:
      log_debugln("NSAPI_ERROR_NO_MEMORY: memory resource not available");
      break;
    case NSAPI_ERROR_NO_SSID:
      log_debugln("NSAPI_ERROR_NO_SSID: ssid not found");
      break;
    ...
    case NSAPI_ERROR_IS_CONNECTED:
      log_debugln("NSAPI_ERROR_IS_CONNECTED: socket is already connected");
      break;
    case NSAPI_ERROR_CONNECTION_LOST:
      log_debugln("NSAPI_ERROR_CONNECTION_LOST: connection lost");
      break;
    case NSAPI_ERROR_CONNECTION_TIMEOUT:
      log_debugln("NSAPI_ERROR_CONNECTION_TIMEOUT: connection timed out");
      break;
    case NSAPI_ERROR_ADDRESS_IN_USE:
      log_debugln("NSAPI_ERROR_ADDRESS_IN_USE: address already in use");
      break;
    case NSAPI_ERROR_TIMEOUT:
      log_debugln("NSAPI_ERROR_TIMEOUT: operation timed out");
      break;
    case NSAPI_ERROR_BUSY:
      ...
      break;
    default:
      log_debugln("%d: unknown error", error);
  }
#endif
}
